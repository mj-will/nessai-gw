...
# This includes calibration uncertainty
...
# Reduce the prior volume to make this example run faster
priors["chirp_mass"].minimum = 15.0
priors["chirp_mass"].maximum = 40.0

# Reduce the parameter space to reduce run time
fixed_parameters = [
    "a_1",
    "a_2",
    "tilt_1",
...
# Run sampler.
# The reparameterisations dictionary supports regex for matching parameter
# this is the easiest way to specify a reparameterisation for all the
