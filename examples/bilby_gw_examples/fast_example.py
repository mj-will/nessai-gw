...
# The `flow_proposal_class` should be set to `GWFlowProposal` for GW PE.
# This includes specific default reparameterisations for certain parameters.
# For example, it knows that theta_jn is an angle.
